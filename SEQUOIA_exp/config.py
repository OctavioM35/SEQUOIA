...
particular_event = 'GW240107_013215'
resume = True                          #True for resuming one event if stopped previously, False for running the event from the begining
...
#Generation and inference of synthetic singal:
